...
#[test]
fn explicit_disabled_telegram_loads_no_telegram_credential_and_preserves_startup() {
...
#[test]
fn enabled_telegram_missing_credential_fails_before_database_or_network_with_fixed_code() {
    let input = format!(
